    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html");
        ...
        try {
            ...
            String URL = "jdbc:sqlserver://localhost:1433;databaseName=empdb;user=sa;password=LYzxcvbnm@123";
            Connection con = DriverManager.getConnection(URL);
            PreparedStatement pstmt = con.prepareStatement("INSERT INTO Employees (id, first, last, age) VALUES (?, ?, ?, ?)");
